                ...
                <div className="relative mx-auto max-w-7xl px-6 py-16">
                    <div className="flex flex-col items-center text-center">
                        ...
                        <p className="mb-12 max-w-2xl text-xl text-foreground/90 text-pretty md:text-2xl">
                            MaiMap parses your codebases into a contextual map, and provides that to your LLM.
                                            ...
                                            <small className="text-sm text-white/70">
                                                *You can unsubscribe at anytime{' '}
                                                <span
                                                    ...
                                                    title="To unsubscribe, enter your email, click 'Join Waitlist' and then click 'Update your preferences'"
                                                >
